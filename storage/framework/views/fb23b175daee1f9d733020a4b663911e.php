...
<?php $component->withAttributes([]); ?>
    ...
    ════════════════════════════════════════════════════════════════════ */
        ...
        <script>
            ...
            const pwRappelCodes = <?php echo json_encode($rappelCodes, 15, 512) ?>;
...
if ($notes) {
    ...
    <div class="pw-wrap">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($currentContact): ?>

            
            <div class="pw-contact-bar">
                <div style="display:flex; align-items:center; gap:1rem;">
                    <div class="pw-contact-avatar">
                        <?php echo e(strtoupper(substr($info['prenom'] ?? ($info['nom'] ?? 'C'), 0, 1) . substr($info['nom'] ?? '?', 0, 1))); ?>

                    </div>
                    <div>
                        <div style="display:flex; align-items:center; gap:0.5rem; flex-wrap:wrap;">
                            <h2 class="pw-contact-name">
                                <?php echo e(Str::upper(trim(($info['prenom'] ?? '') . ' ' . ($info['nom'] ?? ''))) ?: 'CONTACT SANS NOM'); ?>

                            </h2>
                            <span class="pw-badge <?php echo e($statutCls); ?>"><?php echo e($statutLabel); ?></span>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($info['taux_engagement'])): ?>
                                <span style="font-size:0.875rem;"><?php echo e($info['taux_engagement']); ?></span>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($info['rappel_en_retard']) && $info['rappel_en_retard']): ?>
                                <span
                        ...
                        <div class="pw-contact-sub">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($info['siret'])): ?>
                                <span>SIRET&nbsp;<?php echo e($info['siret']); ?></span> ·
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($info['ville'])): ?>
                                <span>📍
                                    <?php echo e($info['ville']); ?><?php echo e(!empty($info['departement']) ? ' (' . $info['departement'] . ')' : ''); ?></span>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($info['type_pressenti']) && $info['type_pressenti'] !== 'Non défini'): ?>
                                · <span>🏢 <?php echo e($info['type_pressenti']); ?></span>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($info['secteur_activite'])): ?>
                                · <span><?php echo e($info['secteur_activite']); ?></span>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($info['nb_salaries'])): ?>
                                · <span>👥 <?php echo e($info['nb_salaries']); ?> sal.</span>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($info['chiffre_affaires'])): ?>
                                · <span>💰 <?php echo e($info['chiffre_affaires']); ?></span>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </div>
                    </div>
                </div>
                ...
                <div style="display:flex; align-items:center; gap:1rem; flex-wrap:wrap;">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($info['telephone_alt'])): ?>
                        <button onclick="copyToClipboard('<?php echo e($info['telephone_alt']); ?>')" class="pw-btn-call-alt">
                    ...
                    <button wire:click="callNow" onclick="startTimer()" class="pw-btn-call">
                        ...
                        <?php echo e($tel ?? 'Appeler'); ?>

                    </button>

                    <div class="pw-en-file">
                        <span class="pw-en-file-num"><?php echo e($nbEnFile); ?></span>
            ...
            <div class="pw-body">
                ...
                <div class="pw-left">
                    ...
                    <div class="pw-tabs">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $onglets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <button wire:click="$set('activeScriptTab', '<?php echo e($key); ?>')"
                                class="pw-tab <?php echo e($activeScriptTab === $key ? 'active' : ''); ?>">
                                <?php echo e($label); ?>
                    ...
                    <div class="pw-script-area">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($scriptCourant): ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($scriptCourant->onglet === 'objections' && $scriptCourant->objections): ?>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $scriptCourant->objections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $obj): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="pw-objection">
                                        <p class="pw-objection-q">"<?php echo e($obj['question']); ?>"</p>
                                        <p class="pw-objection-r">→ <?php echo e($obj['reponse']); ?></p>
                                    </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            <?php elseif($scriptCourant->onglet === 'argumentaire' && $scriptCourant->kpis): ?>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($scriptCourant->contenu): ?>
                                    <div class="pw-script-text"><?php echo nl2br(e($scriptCourant->interpoler($variables))); ?></div>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                <div class="pw-kpis">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $scriptCourant->kpis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kpi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php
                                            $kpiColors = [
                                        ...
                                        ?>
                                        <div class="pw-kpi">
                                            <div class="pw-kpi-val" style="<?php echo e($kpiColor); ?>"><?php echo e($kpi['valeur']); ?>

                                            </div>
                                            <div class="pw-kpi-lbl"><?php echo e($kpi['label']); ?></div>
                                        </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </div>
                            <?php else: ?>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($scriptCourant->interpolerConseil($variables)): ?>
                                <div class="pw-conseil">
                                    ...
                                    <span><?php echo e($scriptCourant->interpolerConseil($variables)); ?></span>
                                </div>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        <?php else: ?>
                            <div class="pw-script-empty">
                                Aucun script disponible pour ce type de campagne.
                                <a href="<?php echo e(route('filament.ns-conseil.resources.script-appels.create')); ?>"
                    ...
                    <div class="pw-infos">
                        <div class="pw-infos-header">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($info['id']) && $info['type'] === 'prospect'): ?>
                                <a href="<?php echo e(route('filament.ns-conseil.resources.prospects.view', $info['id'])); ?>"
                                    target="_blank"
                        ...
                        <div class="pw-info-tabs">
                            <button class="pw-info-tab active" data-tab="contact" onclick="switchInfoTab('contact')">📞
                                Contact</button>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(($info['type'] ?? '') !== 'client'): ?>
                                <button class="pw-info-tab" data-tab="entreprise"
                                    onclick="switchInfoTab('entreprise')">🏢 Entreprise</button>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($info['interlocuteur_nom']) || !empty($info['interlocuteur'])): ?>
                                <button class="pw-info-tab" data-tab="interlocuteur"
                                    onclick="switchInfoTab('interlocuteur')">👤 Interlocuteur</button>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(($info['type'] ?? '') === 'prospect'): ?>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(($info['type'] ?? '') !== 'client'): ?>
                                <button class="pw-info-tab" data-tab="pipeline" onclick="switchInfoTab('pipeline')">📊
                                    Pipeline</button>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(($info['type'] ?? '') === 'prospect' && !empty($info['notes'])): ?>
                            ...
                            <button class="pw-info-tab" data-tab="journal" onclick="switchInfoTab('journal')">
                                📋 Journal
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(count($callHistory) > 0): ?>
                                    <span
                                        style="display:inline-flex;align-items:center;justify-content:center;min-width:1.25rem;height:1.25rem;padding:0 0.25rem;border-radius:9999px;background:rgb(99 102 241);color:white;font-size:0.65rem;font-weight:700;margin-left:0.25rem;"><?php echo e(count($callHistory)); ?></span>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </button>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(($info['type'] ?? '') !== 'client'): ?>
                            ...
                            <div class="pw-info-grid">
                                <div class="pw-field-full">
                                    ...
                                    <div style="display:flex; gap:0.5rem; align-items:center;">
                                        <span
                                            ...
                                            +33</span>
                                        <input type="text" value="<?php echo e($info['telephone'] ?? ''); ?>" readonly
                                            class="pw-field-input"
                                            style="flex:1; font-weight:600; font-size:0.9375rem; letter-spacing:0.025em;"
                                            onclick="this.select(); document.execCommand('copy');"
                                            title="Cliquer pour copier">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($info['telephone'])): ?>
                                            <a href="tel:<?php echo e($info['telephone']); ?>"
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($info['telephone_alt'])): ?>
                                    <div class="pw-field-full">
                                        ...
                                        <input type="text" value="<?php echo e($info['telephone_alt']); ?>" readonly
                                            class="pw-field-input"
                                            onclick="this.select(); document.execCommand('copy');"
                                            title="Cliquer pour copier">
                                    </div>
                                ...
                                <div>
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($info['email'])): ?>
                                        <a href="mailto:<?php echo e($info['email']); ?>"
                                            style="font-size:0.8125rem; color:rgb(37 99 235);"><?php echo e($info['email']); ?></a>
                                    <?php else: ?>
                                ...
                                <div>
                                    ...
                                    <div class="pw-field-value">
                                        <?php echo e(collect([$info['ville'] ?? null, $info['code_postal'] ?? null, $info['departement'] ?? null])->filter()->implode(' · ') ?:'—'); ?>

                                    </div>
                                </div>

                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($info['adresse_complete'])): ?>
                                    <div class="pw-field-full">
                                        <div class="pw-field-label">Adresse complète</div>
                                        <div class="pw-field-value" style="font-size:0.8125rem;">
                                            <?php echo e($info['adresse_complete']); ?></div>
                                    </div>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </div>
                        </div>
                            ...
                            <div class="pw-info-grid">
                                <div>
                                    ...
                                    <div class="pw-field-value" style="font-weight:700; font-size:0.9375rem;">
                                        <?php echo e($info['nom'] ?? '—'); ?></div>
                                </div>
                                <div>
                                    <div class="pw-field-label">SIRET</div>
                                    <div class="pw-field-value copyable"
                                        onclick="copyToClipboard('<?php echo e($info['siret'] ?? ''); ?>')">
                                        <?php echo e($info['siret'] ?? '—'); ?>

                                    </div>
                                </div>
                                <div>
                                    <div class="pw-field-label">Type pressenti</div>
                                    <div class="pw-field-value"><?php echo e($info['type_pressenti'] ?? '—'); ?></div>
                                </div>
                                <div>
                                    <div class="pw-field-label">Secteur d'activité</div>
                                    <div class="pw-field-value"><?php echo e($info['secteur_activite'] ?? '—'); ?></div>
                                </div>
                                <div>
                                    <div class="pw-field-label">Nombre de salariés</div>
                                    <div class="pw-field-value">
                                        <?php echo e($info['nb_salaries'] ?? null ? $info['nb_salaries'] . ' salariés' : '—'); ?>

                                    </div>
                                </div>
                                <div>
                                    <div class="pw-field-label">Chiffre d'affaires</div>
                                    <div class="pw-field-value"><?php echo e($info['chiffre_affaires'] ?? '—'); ?></div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="pw-interlocuteur-card">
                                    <div
                                        ...
                                        <div
                                            ...
                                            <?php echo e(strtoupper(substr($info['interlocuteur_nom'] ?? ($info['interlocuteur'] ?? '?'), 0, 1))); ?>

                                        </div>
                                        <div>
                                            <div style="font-weight:700; font-size:0.9375rem;">
                                                <?php echo e($info['interlocuteur_nom'] ?? ($info['interlocuteur'] ?? '—')); ?>

                                            </div>
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($info['interlocuteur_fonction'])): ?>
                                                <div style="font-size:0.8125rem; color:rgb(107 114 128);">
                                                    <?php echo e($info['interlocuteur_fonction']); ?></div>
                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        </div>
                                    </div>
                                    <div class="pw-info-grid">
                                        <div>
                                            ...
                                            <div class="pw-field-value"><?php echo e($info['interlocuteur_telephone'] ?? '—'); ?>

                                            </div>
                                        </div>
                                        <div>
                                            <div class="pw-field-label">Email direct</div>
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($info['interlocuteur_email'])): ?>
                                                <a href="mailto:<?php echo e($info['interlocuteur_email']); ?>"
                                                    style="font-size:0.8125rem; color:rgb(37 99 235);"><?php echo e($info['interlocuteur_email']); ?></a>
                                            <?php else: ?>
                        ...
                        <div class="pw-info-panel" data-tab="pipeline" style="display:none;">
                            <div class="pw-info-grid">
                                <div>
                                    ...
                                    <span class="pw-badge <?php echo e($statutCls); ?>"
                                ...
                                <div>
                                    ...
                                    <div class="pw-field-value"><?php echo e($info['teleprospecteur'] ?? '—'); ?></div>
                                </div>
                                <div>
                                    <div class="pw-field-label">Commercial</div>
                                    <div class="pw-field-value"><?php echo e($info['commercial'] ?? '—'); ?></div>
                                </div>
                                <div>
                                    <div class="pw-field-label">1er contact</div>
                                    <div class="pw-field-value">
                                        <?php echo e($info['date_premier_contact'] ?? 'Jamais contacté'); ?></div>
                                </div>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($info['rappel_planifie_at'])): ?>
                                    <div class="pw-field-full">
                                        <div class="pw-field-label">Rappel planifié</div>
                                        <div class="pw-field-value <?php echo e($info['rappel_en_retard'] ? 'pbo-rappel-retard' : ''); ?>"
                                            style="<?php echo e($info['rappel_en_retard'] ? 'color:rgb(239 68 68); font-weight:700;' : ''); ?>">
                                            🕐 <?php echo e($info['rappel_planifie_at']); ?>

                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($info['rappel_en_retard']): ?>
                                                — EN RETARD
                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        </div>
                                    </div>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($info['statut_description'])): ?>
                                    <div class="pw-field-full">
                                        <div class="pw-field-label">Description statut</div>
                                        <div class="pw-field-value"
                                            style="font-size:0.8125rem; color:rgb(107 114 128);">
                                            <?php echo e($info['statut_description']); ?></div>
                                    </div>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </div>
                        </div>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($noteLines)): ?>
                            <div class="pw-info-panel" data-tab="notes" style="display:none;">
                                <div class="pw-notes-list">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = array_reverse($noteLines); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $note): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="pw-note-item">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($note['date']): ?>
                                                <div class="pw-note-date"><?php echo e($note['date']); ?></div>
                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                            <div style="font-size:0.8125rem;"><?php echo e($note['text']); ?></div>
                                        </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </div>
                            </div>
                        ...
                        <div class="pw-info-panel" data-tab="journal" style="display:none;">
                            ...
                            <?php else: ?>
                                <div style="display:flex; flex-direction:column; gap:0.625rem;">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $callHistory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $appel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php
                                        ...
                                        ?>
                                        <div
                                            style="border-radius:0.5rem; border:1px solid <?php echo e($jColor['border']); ?>; background:<?php echo e($jColor['bg']); ?>; padding:0.625rem 0.75rem;">
                                            <div
                                                style="display:flex; justify-content:space-between; align-items:flex-start; margin-bottom:0.375rem;">
                                                <div
                                                    style="display:flex; align-items:center; gap:0.5rem; flex-wrap:wrap;">
                                                    <span
                                                        style="font-size:0.7rem; font-weight:700; padding:0.125rem 0.5rem; border-radius:9999px; background:<?php echo e($jColor['badge']); ?>; color:white; text-transform:uppercase; letter-spacing:0.05em;">
                                                        <?php echo e($appel['statut_label']); ?>

                                                    </span>
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($appel['campagne'] ?? null): ?>
                                                        <span
                                                            ...
                                                            <?php echo e($appel['campagne']); ?>

                                                        </span>
                                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                </div>
                                                <span
                                                    style="font-size:0.7rem; color:rgb(107 114 128); white-space:nowrap; margin-left:0.5rem;"><?php echo e($appel['date']); ?></span>
                                            </div>
                                            <div
                                                style="font-size:0.75rem; color:rgb(55 65 81); margin-bottom:<?php echo e($appel['notes'] ? '0.25rem' : '0'); ?>;">
                                                <span style="font-weight:600;"><?php echo e($appel['agent']); ?></span>
                                            </div>
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($appel['notes']): ?>
                                                <div
                                                    style="font-size:0.75rem; color:rgb(75 85 99); background:rgba(255,255,255,0.6); border-radius:0.25rem; padding:0.25rem 0.5rem; margin-top:0.25rem; border-left:2px solid <?php echo e($jColor['badge']); ?>;">
                                                    <?php echo e($appel['notes']); ?>
                ...
                <div class="pw-right">
                    ...
                    <div class="pw-nr-box">
                        ...
                        <div style="display:flex; align-items:baseline; gap:0.375rem; margin-bottom:0.5rem;">
                            <span class="pw-nr-count"><?php echo e($tentativesActuelles); ?></span>
                            <span class="pw-nr-tentatives">/ <?php echo e($maxTentatives); ?> tentatives</span>
                        </div>
                        
                        <div style="display:flex; gap:0.25rem;">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php for($i = 0; $i < $maxTentatives; $i++): ?>
                                <div
                                    style="flex:1; height:0.25rem; border-radius:9999px; background:<?php echo e($i < $tentativesActuelles ? 'rgb(249 115 22)' : 'rgb(229 231 235)'); ?>;">
                                </div>
                    ...
                    <div style="display:flex; flex-direction:column; gap:0.875rem;">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $statutsGroupes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $groupeKey => $groupe): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div>
                                <div style="font-size:0.65rem; font-weight:700; text-transform:uppercase; letter-spacing:0.06em; color:rgb(100 116 139); margin-bottom:0.375rem; padding-bottom:0.25rem; border-bottom:1px solid rgb(241 245 249);">
                                    <?php echo e($groupe['label']); ?>

                                </div>
                                <div style="display:grid; gap:0.375rem;">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $groupe['statuts']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php
                                            $isActive = $statut_resultat === $option['value'];
                                        ?>
                                        <label wire:click="$set('statut_resultat', '<?php echo e($option['value']); ?>')"
                                            onclick="toggleRappel('<?php echo e($option['value']); ?>')"
                                      ...
                                      border:1.5px solid <?php echo e($isActive ? 'currentColor' : 'rgb(226 232 240)'); ?>;
                                      background:<?php echo e($isActive ? 'rgba(0,0,0,0.03)' : 'white'); ?>;
                                      <?php echo e($isActive ? $option['bar'] . '; border-color:' . \Illuminate\Support\Str::after($option['bar'], 'background:') . ';' : ''); ?>">
                                            <div style="font-size:1.1rem; width:1.5rem; text-align:center; flex-shrink:0;">
                                                <?php echo e($option['icon'] ?? '•'); ?></div>
                                            <div style="flex:1; min-width:0;">
                                                <div
                                                    style="font-size:0.8125rem; font-weight:600; color:<?php echo e($isActive ? 'white' : 'rgb(30 41 59)'); ?>;">
                                                    <?php echo e($option['label']); ?>

                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($option['prioritaire'])): ?>
                                                ...
                                                <div
                                                    style="font-size:0.7rem; color:<?php echo e($isActive ? 'rgba(255,255,255,0.8)' : 'rgb(100 116 139)'); ?>;">
                                                    <?php echo e($option['sub']); ?></div>
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($option['action'])): ?>
                                                    <div style="font-size:0.65rem; color:<?php echo e($isActive ? 'rgba(255,255,255,0.7)' : 'rgb(148 163 184)'); ?>; margin-top:2px;">
                                                        → <?php echo e($option['action']); ?>
                                            ...
                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                            <input type="radio" wire:model="statut_resultat" value="<?php echo e($option['value']); ?>"
                                                style="display:none;">
                                        </label>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </div>
                    ...
                    <div id="pw-rappel-box"
                        class="pw-rappel-box <?php echo e(in_array($statut_resultat, $rappelCodes) ? 'visible' : ''); ?>">
                        <div class="pw-rappel-box-title">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array($statut_resultat, ['rapl_elu', 'rapl_std'])): ?>
                                ⏰ Créneau de rappel
                            <?php else: ?>
                                📅 Planifier le rappel / RDV
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </div>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($statut_resultat === 'rapl_elu'): ?>
                        ...
                        <?php elseif($statut_resultat === 'rapl_std'): ?>
                            <div style="font-size:0.7rem; background:#fffbe6; border:1px dashed #d4a800; border-radius:4px; padding:4px 8px; color:#7a5c00; margin-bottom:0.5rem;">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($statut_resultat === 'rdv'): ?>
                            ...
                            <div style="padding:0.875rem; display:flex; flex-direction:column; gap:0.625rem;">
                                ...
                                <div style="display:grid; grid-template-columns:1fr 1fr; gap:0.5rem;">
                                    ...
                                    <div>
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$enregistrement_appel_joint): ?>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($statut_resultat === 'cse_ni'): ?>
                        <div style="margin-top:0.75rem; background:rgb(255 251 235); border:2px solid rgb(234 179 8); border-radius:0.5rem; overflow:hidden;">
                            ...
                            <div style="padding:0.875rem; font-size:0.8125rem; color:rgb(92 52 8);">
                                ...
                                <ul style="margin:0; padding-left:1.25rem; font-size:0.75rem; color:rgb(120 53 15); line-height:1.7;">
                                    ...
                                    <li>Date rappel J+7 → bloc rappel ci-dessus (auto : <?php echo e(now()->addDays(7)->format('d/m/Y')); ?>)</li>
                                </ul>
                            </div>
                        </div>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array($statut_resultat, ['bloc2', 'ncse_50', 'ncse_plus50', 'cse_zone'])): ?>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($statut_resultat && in_array($statut_resultat, ['rapl_elu', 'rapl_std']) && !$commentaires): ?>
                        <div
                            style="font-size:0.75rem; color:rgb(220 38 38); margin-top:0.5rem; display:flex; align-items:center; gap:0.25rem;">
                            📝 Note obligatoire : date + heure + nom <?php echo e($statut_resultat === 'rapl_elu' ? 'de l\'élu' : 'du standard'); ?>.
                        </div>
                    <?php elseif($statut_resultat && !$commentaires && !in_array($statut_resultat, ['nrp', 'fax', 'maj'])): ?>
                        <div
                    ...
                    <div class="pw-actions">
                        <button wire:click="submitResult" class="pw-btn-primary"
                            <?php echo e(!$statut_resultat ? 'disabled style=opacity:.5;cursor:not-allowed' : ''); ?>>
                            ✓ Enregistrer &amp; suivant
                        </button>
            ...
            <div style="display:flex; align-items:center; justify-content:center; min-height:60vh;">
                <div style="text-align:center;">
                    ...
                    <div style="display:flex; gap:0.75rem; justify-content:center; flex-wrap:wrap;">
                        ...
                        <a href="<?php echo e(route('filament.ns-conseil.pages.phoning-back-office')); ?>"
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\crmfilament\resources\views/filament/ns-conseil/pages/phoning-workflow.blade.php ENDPATH**/ ?>