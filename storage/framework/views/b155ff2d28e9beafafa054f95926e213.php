    ...
    <?php $__env->startPush('scripts'); ?>
        ...
        <script>
            ...
            function initSortable() {
                ...
                sortableInstance = new Sortable(list, {
                    ...
                    onEnd: function() {
                        ...
                        // Appeler la méthode Livewire (sans window.Livewire.find('<?php echo e($_instance->getId()); ?>') qui cause l'erreur)
            ...
            function pboUpdateSelection() {
                ...
                window.Livewire.find('<?php echo e($_instance->getId()); ?>').set('selectedIds', checked);
            }
            ...
            function pboDeselectAll() {
                ...
                const bar = document.getElementById('pbo-bulk-bar');
                if (bar) bar.classList.remove('visible');
                window.Livewire.find('<?php echo e($_instance->getId()); ?>').set('selectedIds', []);
            }
    ...
    <div class="pbo">
        ...
        <div class="pbo-topbar">
            ...
            <div class="pbo-user-select-wrap">
                <select wire:change="selectUser($event.target.value)" class="pbo-user-select">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $teleprospecteurs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($user['id']); ?>" <?php echo e($selectedUserId === $user['id'] ? 'selected' : ''); ?>>
                            <?php echo e($user['nom_complet']); ?> — <?php echo e($user['nb_actifs']); ?>

                            prospect<?php echo e($user['nb_actifs'] > 1 ? 's' : ''); ?>

                        </option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(empty($teleprospecteurs)): ?>
            ...
            <div class="pbo-pills">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($nbRetard > 0): ?>
                    <div class="pbo-pill pbo-pill-danger">
                        <div class="pdot" style="background:#ef4444;"></div>
                        <?php echo e($nbRetard); ?> retard<?php echo e($nbRetard > 1 ? 's' : ''); ?>

                    </div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($nbTotal > 0): ?>
                    <div class="pbo-pill pbo-pill-blue">
                        <div class="pdot" style="background:#3b82f6;"></div>
                        <?php echo e($nbTotal); ?> en file
                    </div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                <span id="pbo-save-ind" class="pbo-saving" style="display:none;">✓ Sauvegardé</span>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($selectedUser && $nbTotal > 0): ?>
        ...
        <div class="pbo-table-wrap">
            ...
            <div class="pbo-legend-bar">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = ['rpc' => 'RPC', 'rp' => 'RP', 'std_joint' => 'STD-Joint', 'ac' => 'AC', 'cse_nr' => 'CSE-NR', 'std_nr' => 'STD-NR']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $l): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="pbo-leg-item">
                        <div class="pbo-leg-dot <?php echo e('dot-' . $k); ?>"></div>
                        <?php echo e($l); ?>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($nbTotal === 0): ?>
                    <div class="pbo-empty">
                        ...
                        <div class="pbo-empty-sub">
                            <?php echo e($selectedUser ? 'Ce téléprospecteur n\'a aucun prospect actif.' : 'Sélectionnez un téléprospecteur ci-dessus.'); ?>

                        </div>
                    </div>
                <?php else: ?>
                    <div id="pbo-sortable-list">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
                                $rank = $i + 1;
                            ...
                            ?>
                            <div class="pbo-row" wire:key="row-<?php echo e($p['id']); ?>" data-id="<?php echo e($p['id']); ?>"
                                data-nom="<?php echo e(strtolower($p['nom'])); ?>" data-tel="<?php echo e($p['telephone'] ?? ''); ?>">
                                ...
                                <div class="pbo-cell pbo-col-rank <?php echo e($rank <= 3 ? 'r' . $rank : ''); ?>">
                                    <?php echo e($rank); ?>
                                ...
                                <div class="pbo-cell pbo-col-nom">
                                    <div class="pbo-nom-avatar <?php echo e($avCls); ?>"><?php echo e($initials); ?></div>
                                    <div class="pbo-nom-text">
                                        <div class="pbo-nom-name">
                                            <?php echo e($p['nom']); ?>

                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($rank === 1): ?>
                                                <span class="pbo-badge-next">PROCHAIN</span>
                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        </div>
                                        <div class="pbo-nom-sub">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($p['interlocuteur'] && $p['interlocuteur'] !== 'Non défini'): ?>
                                                <?php echo e($p['interlocuteur']); ?>

                                            <?php elseif($p['secteur_activite']): ?>
                                                <?php echo e($p['secteur_activite']); ?>

                                            <?php elseif($p['type_pressenti'] && $p['type_pressenti'] !== 'Non défini'): ?>
                                                <?php echo e($p['type_pressenti']); ?>

                                            <?php else: ?>
                                                &nbsp;
                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($p['nb_salaries']): ?>
                                                · <?php echo e($p['nb_salaries']); ?> sal.
                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="pbo-cell pbo-col-statut">
                                    <div class="pbo-status-dot <?php echo e($dotCls); ?>"></div>
                                    <span
                                        class="pbo-status-label <?php echo e($lblCls); ?>"><?php echo e($p['statut_label']); ?></span>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($p['rappel_en_retard']): ?>
                                ...
                                <div class="pbo-cell pbo-col-tel">
                                    <?php echo e($p['telephone'] ?? '—'); ?>

                                </div>

                                
                                <div class="pbo-cell pbo-col-dept">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($p['ville'] || $p['departement']): ?>
                                        <svg width="10" height="10" fill="none" stroke="currentColor"
                                            viewBox="0 0 24 24" style="flex-shrink:0;">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                                        </svg>
                                        <?php echo e($p['ville']); ?><?php echo e($p['departement'] ? ' (' . $p['departement'] . ')' : ''); ?>
                                ...
                                <div class="pbo-cell pbo-col-rappel">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($p['rappel_planifie_at']): ?>
                                        <span class="<?php echo e($p['rappel_en_retard'] ? 'pbo-rappel-late' : ''); ?>">
                                            <?php echo e($p['rappel_planifie_at']); ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($selectedUser): ?>
                <div class="pbo-footer">
                    <div class="pbo-fstat">
                        <span class="pbo-fstat-val"><?php echo e($nbTotal); ?></span>
                        <span>prospect<?php echo e($nbTotal > 1 ? 's' : ''); ?></span>
                    </div>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($nbRpc > 0): ?>
                        <div class="pbo-fstat">
                            <span class="pbo-fstat-val" style="color:#0d9488;"><?php echo e($nbRpc); ?></span>
                            <span>RPC</span>
                        </div>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($nbRp > 0): ?>
                        <div class="pbo-fstat">
                            <span class="pbo-fstat-val" style="color:#16a34a;"><?php echo e($nbRp); ?></span>
                            <span>RP</span>
                        </div>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($nbRappels > 0): ?>
                        <div class="pbo-fstat">
                            <span class="pbo-fstat-val"><?php echo e($nbRappels); ?></span>
                            <span>avec rappel</span>
                        </div>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($nbRetard > 0): ?>
                        <div class="pbo-fstat" style="color:#dc2626;">
                            <span class="pbo-fstat-val" style="color:#dc2626;"><?php echo e($nbRetard); ?></span>
                            <span>en retard</span>
                        </div>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\crmfilament\resources\views/filament/ns-conseil/pages/phoning-back-office.blade.php ENDPATH**/ ?>