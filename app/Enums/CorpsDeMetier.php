...
enum CorpsDeMetier: string implements HasLabel, HasColor, HasIcon
{
    ...
    {
        return match($this) {
            self::Plomberie   => ['type_fuite' => 'Type de fuite ?', 'localisation' => 'Où se situe la fuite ?', 'robinet_ferme' => "Robinet d'arrivée fermé ?"],
            self::Electricite => ['disjoncteur' => 'Le disjoncteur a-t-il sauté ?', 'zone_concernee' => 'Quelle zone est concernée ?', 'prise_surchauffee' => 'Prise surchauffée ?'],
            self::Serrurerie  => ['type_serrure' => 'Type de serrure ?', 'cle_disponible' => 'Clés disponibles ?', 'type_porte' => 'Type de porte ?'],
            self::Chauffage   => ['type_chauffage' => 'Type de chauffage ?', 'marque_chaudiere' => 'Marque de la chaudière ?', 'age_installation' => "Âge de l'installation ?"],
            default           => [],
        };
    }
