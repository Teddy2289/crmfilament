...
class AffairesInterventionsRelationManager extends RelationManager
{
    ...
    {
        return \App\Filament\Allopro\Resources\AffaireInterventionResource::form($form);
    }
        ...
        return $table
            ...
            ->actions([
                ...
                Tables\Actions\ViewAction::make()
                    ->url(fn(AffaireIntervention $record) =>
                        \App\Filament\Allopro\Resources\AffaireInterventionResource::getUrl('view', ['record' => $record])
                    ),
