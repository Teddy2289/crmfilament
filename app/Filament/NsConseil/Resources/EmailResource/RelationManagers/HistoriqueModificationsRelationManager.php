...
namespace App\Filament\NsConseil\Resources\EmailResource\RelationManagers;
        ...
        return $table
            ...
            ->actions([
                Tables\Actions\ViewAction::make()
                    ...
                    ->modalContent(fn (HistoriqueModification $record) => view('filament.resources.email.historique-detail', ['record' => $record])),
            ])
            ->bulkActions([
