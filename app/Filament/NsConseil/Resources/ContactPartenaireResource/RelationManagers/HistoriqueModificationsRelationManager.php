...
namespace App\Filament\NsConseil\Resources\ContactPartenaireResource\RelationManagers;
        ...
        return $table
            ...
            ->actions([
                Tables\Actions\ViewAction::make()
                    ...
                    ->modalContent(fn (HistoriqueModification $record) => view('filament.resources.contact-partenaire.historique-detail', ['record' => $record])),
            ])
            ->bulkActions([
