...
namespace App\Filament\NsConseil\Resources\CampagnePhoningResource\RelationManagers;
        ...
        return $table
            ...
            ->actions([
                Tables\Actions\ViewAction::make()
                    ...
                    ->modalContent(fn (HistoriqueModification $record) => view('filament.resources.campagne-phoning.historique-detail', ['record' => $record])),
            ])
            ->bulkActions([
