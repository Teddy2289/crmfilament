...
namespace App\Filament\NsConseil\Resources\AppelResource\RelationManagers;
        ...
        return $table
            ...
            ->actions([
                Tables\Actions\ViewAction::make()
                    ...
                    ->modalContent(fn (HistoriqueModification $record) => view('filament.resources.appel.historique-detail', ['record' => $record])),
            ])
            ->bulkActions([
