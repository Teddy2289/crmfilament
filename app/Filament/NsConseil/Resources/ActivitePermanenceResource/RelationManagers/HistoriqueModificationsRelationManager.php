...
namespace App\Filament\NsConseil\Resources\ActivitePermanenceResource\RelationManagers;
        ...
        return $table
            ...
            ->actions([
                Tables\Actions\ViewAction::make()
                    ...
                    ->modalContent(fn (HistoriqueModification $record) => view('filament.resources.activite-permanence.historique-detail', ['record' => $record])),
            ])
            ->bulkActions([
