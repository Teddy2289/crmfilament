...
namespace App\Filament\NsConseil\Resources\DocumentResource\RelationManagers;
        ...
        return $table
            ...
            ->actions([
                Tables\Actions\ViewAction::make()
                    ...
                    ->modalContent(fn (HistoriqueModification $record) => view('filament.resources.document.historique-detail', ['record' => $record])),
            ])
            ->bulkActions([
