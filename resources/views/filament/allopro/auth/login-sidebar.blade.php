<aside id="crm-ap-sidebar" aria-hidden="true">
    <div style="display:flex;align-items:center;gap:10px;padding:4px 6px 16px;border-bottom:1px solid #e7ebef;">
        ...
        <div>
            <div style="font-size:13px;font-weight:700;color:#1f2a33;line-height:1.2;">ALLOPRO 24/24</div>
            <div style="font-size:11px;color:#6e7b87;margin-top:2px;">Centre de contact</div>
        </div>
    </div>
