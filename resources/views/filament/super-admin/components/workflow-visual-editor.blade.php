...
<div x-data="workflowEditor()" x-init="initEditor()" class="workflow-visual-editor" style="height: 600px; width: 100%; border: 1px solid #e5e7eb; border-radius: 0.5rem; overflow: hidden;">
    ...
    return {
        ...
        addNode(type) {
            const newNode = {
                ...
                label: `Nouveau ${type}`,
                type: type,
                ordre: this.nodes.length + 1,
                x: 50 + (this.nodes.length * 200),
                y: 50,
                config: {}
            };
        ...
        saveWorkflow() {
            this.$dispatch('workflow-saved', { nodes: this.nodes });
        }
    };
}
</script>
