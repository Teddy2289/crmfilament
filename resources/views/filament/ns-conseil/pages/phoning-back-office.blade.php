...
══════════════════════════════════════════════════ */
.pbo *, .pbo *::before, .pbo *::after { box-sizing: border-box; }
.pbo {
...
.pbo-topbar-spacer { flex: 1; }

/* Pills stats */
.pbo-pills { display: flex; gap: 8px; align-items: center; flex-wrap: wrap; }
.pbo-pill {
...
.pbo-pill .pdot { width: 7px; height: 7px; border-radius: 50%; }
.pbo-pill-danger { background: #fef2f2; border-color: #fecaca; color: #dc2626; }
.dark .pbo-pill-danger { background: #2d1515; border-color: #7f1d1d; color: #f87171; }
.pbo-pill-blue { background: #eff6ff; border-color: #bfdbfe; color: #1d4ed8; }
.dark .pbo-pill-blue { background: #1e2240; border-color: #1e3a8a; color: #93c5fd; }
...
.pbo-btn-reset:hover { background: #fee2e2; border-color: #f87171; }
.dark .pbo-btn-reset { background: #2d1515; border-color: #7f1d1d; color: #f87171; }
...
.pbo-filters-head {
    ...
    letter-spacing: .08em; color: var(--pbo-muted);
    margin-bottom: 10px;
}
.pbo-filters-row {
    display: flex; align-items: flex-end; gap: 10px; flex-wrap: wrap;
}
.pbo-filter-group { display: flex; flex-direction: column; gap: 4px; }
.pbo-filter-group label {
    font-size: 11px; font-weight: 500; color: var(--pbo-muted);
...
.dark .pbo-finput { background: #1a1d28; border-color: #2a2e3d; color: #e5e7eb; }
.pbo-finput-search { min-width: 200px; }
.pbo-finput-dept  { width: 120px; }
.pbo-finput-date  { width: 140px; }
...
.pbo-fselect:focus { border-color: var(--pbo-accent); }
.dark .pbo-fselect { background: #1a1d28; border-color: #2a2e3d; color: #e5e7eb; }

.pbo-filter-actions { display: flex; gap: 6px; align-items: flex-end; }
.pbo-btn-filter {
    display: inline-flex; align-items: center; gap: 5px;
    padding: 0 14px; height: 34px;
    background: var(--pbo-accent); color: white;
    border: none; border-radius: 6px;
    font-size: 12.5px; font-weight: 600; font-family: 'Inter', sans-serif;
    cursor: pointer; transition: background .15s;
}
.pbo-btn-filter:hover { background: #1d4ed8; }
.pbo-btn-clear {
    display: inline-flex; align-items: center; justify-content: center;
    width: 34px; height: 34px;
    background: var(--pbo-bg2); border: 1px solid var(--pbo-border);
    border-radius: 6px; color: var(--pbo-muted); cursor: pointer;
    transition: all .15s;
}
.pbo-btn-clear:hover { background: #f3f4f6; color: var(--pbo-text); }
.dark .pbo-btn-clear { background: #1a1d28; border-color: #2a2e3d; }
.dark .pbo-btn-clear:hover { background: #252836; }
...
.pbo-table-body::-webkit-scrollbar { width: 5px; }
.pbo-table-body::-webkit-scrollbar-track { background: transparent; }
.pbo-table-body::-webkit-scrollbar-thumb { background: #d1d5db; border-radius: 9px; }
.dark .pbo-table-body::-webkit-scrollbar-thumb { background: #374151; }
...
.dark .pbo-row { border-bottom-color: #1a1d28; }
.pbo-row:last-child { border-bottom: none; }
.pbo-row:hover { background: #f8faff; }
.dark .pbo-row:hover { background: #131724; }

/* Drag states */
.pbo-row.sortable-ghost { opacity: .35; background: #eff6ff; }
.dark .pbo-row.sortable-ghost { background: #1c2240; }
...
.dark .pbo-row.sortable-chosen { background: #1c2240; }
...
.pbo-row:hover .pbo-col-grip { color: #9ca3af; }
.pbo-col-grip:active { cursor: grabbing; }
...
.pbo-checkbox:checked {
    background: var(--pbo-accent); border-color: var(--pbo-accent);
    ...
    background-size: 10px 8px; background-position: center; background-repeat: no-repeat;
}
.dark .pbo-checkbox { background: #1a1d28; border-color: #374151; }
...
.pbo-col-rank.r1 { color: #d97706; }
.pbo-col-rank.r2 { color: #6b7280; }
.pbo-col-rank.r3 { color: #92400e; }

/* Col nom */
.pbo-col-nom { gap: 8px; padding-left: 2px; }
.pbo-nom-avatar {
...
.pbo-nom-sub {
    font-size: 10.5px; color: var(--pbo-muted);
    white-space: nowrap; overflow: hidden; text-overflow: ellipsis;
    margin-top: 1px;
}
.pbo-badge-next {
...
/* Col statut */
.pbo-col-statut { gap: 6px; }
.pbo-status-dot { width: 7px; height: 7px; border-radius: 50%; flex-shrink: 0; }
.pbo-status-label { font-size: 12px; font-weight: 500; }
.pbo-badge-late {
...
/* Col téléphone */
.pbo-col-tel { font-family: 'JetBrains Mono', monospace; font-size: 11.5px; color: var(--pbo-muted); }

/* Col département */
.pbo-col-dept { font-size: 12px; color: var(--pbo-muted); gap: 4px; }

/* Col rappel */
.pbo-col-rappel { font-size: 11px; font-family: 'JetBrains Mono', monospace; color: var(--pbo-muted); }
.pbo-rappel-late { color: #dc2626; font-weight: 600; }

/* Col engagement */
.pbo-col-eng { justify-content: center; font-size: 11.5px; font-family: 'JetBrains Mono', monospace; color: var(--pbo-muted); }

/* ── Couleurs statuts ── */
.dot-rpc        { background: #14b8a6; }
.dot-rp         { background: #22c55e; }
.dot-std_joint  { background: #3b82f6; }
.dot-ac         { background: #9ca3af; }
.dot-std_nr     { background: #d1d5db; }
.dot-cse_nr     { background: #f97316; }
.dot-ko         { background: #ef4444; }

.lbl-rpc        { color: #0d9488; }
.lbl-rp         { color: #16a34a; }
.lbl-std_joint  { color: #2563eb; }
.lbl-ac         { color: #374151; }
.lbl-std_nr     { color: #6b7280; }
.lbl-cse_nr     { color: #c2410c; }
.lbl-ko         { color: #b91c1c; }
.dark .lbl-ac   { color: #9ca3af; }
.dark .lbl-std_nr { color: #6b7280; }

/* Couleur avatar par initiale */
.av-a { background: linear-gradient(135deg,#6366f1,#8b5cf6); }
.av-b { background: linear-gradient(135deg,#0ea5e9,#2563eb); }
.av-c { background: linear-gradient(135deg,#10b981,#059669); }
.av-d { background: linear-gradient(135deg,#f59e0b,#d97706); }
.av-e { background: linear-gradient(135deg,#ec4899,#db2777); }
.av-f { background: linear-gradient(135deg,#14b8a6,#0d9488); }
.av-g { background: linear-gradient(135deg,#f97316,#ea580c); }
.av-h { background: linear-gradient(135deg,#a855f7,#9333ea); }
.av-i { background: linear-gradient(135deg,#06b6d4,#0891b2); }
.av-j { background: linear-gradient(135deg,#84cc16,#65a30d); }
.av-k { background: linear-gradient(135deg,#ef4444,#dc2626); }
.av-l { background: linear-gradient(135deg,#3b82f6,#1d4ed8); }
.av-m { background: linear-gradient(135deg,#8b5cf6,#7c3aed); }
.av-n { background: linear-gradient(135deg,#06b6d4,#2563eb); }
.av-o { background: linear-gradient(135deg,#f59e0b,#ef4444); }
.av-p { background: linear-gradient(135deg,#10b981,#6366f1); }
...
.pbo-bulk-bar {
    ...
    font-size: 12.5px; font-weight: 500; color: #1d4ed8;
}
.dark .pbo-bulk-bar { background: #1c2240; border-color: #1e3a8a; color: #93c5fd; }
.pbo-bulk-bar.visible { display: flex; }
.pbo-bulk-btn {
...
.pbo-bulk-btn:hover { background: #dbeafe; }
.dark .pbo-bulk-btn { background: #1e2240; border-color: #2d3a6e; color: #93c5fd; }
.pbo-bulk-btn-danger { border-color: #fca5a5; color: #dc2626; }
.pbo-bulk-btn-danger:hover { background: #fef2f2; }
...
.pbo-fstat { display: flex; align-items: center; gap: 5px; font-size: 11.5px; color: var(--pbo-muted); }
.pbo-fstat-val { font-weight: 700; font-family: 'JetBrains Mono', monospace; font-size: 12px; color: var(--pbo-text); }
.pbo-footer-note { margin-left: auto; font-size: 10.5px; color: #c5c9d2; font-style: italic; white-space: nowrap; }

/* ── Empty ── */
.pbo-empty {
    display: flex; flex-direction: column; align-items: center; justify-content: center;
    padding: 60px 20px; color: #c5c9d2;
}
.pbo-empty-icon { font-size: 32px; margin-bottom: 10px; opacity: .6; }
.pbo-empty-title { font-size: 14px; font-weight: 600; color: var(--pbo-muted); }
.pbo-empty-sub { font-size: 12px; margin-top: 4px; color: #c5c9d2; }

/* ── Saving flash ── */
@keyframes pbo-flash { 0%,100%{opacity:0} 20%,80%{opacity:1} }
.pbo-saving { font-size: 11px; color: #2563eb; font-weight: 600; animation: pbo-flash .9s ease-out; }
...
.pbo-leg-item { display: flex; align-items: center; gap: 4px; font-size: 10.5px; color: var(--pbo-muted); font-weight: 500; }
.pbo-leg-dot { width: 7px; height: 7px; border-radius: 2px; }

/* Drag hint */
.pbo-drag-hint { margin-left: auto; font-size: 10.5px; color: #c5c9d2; font-style: italic; display: flex; align-items: center; gap: 4px; }
</style>
@endpush
...
function initSortable() {
    ...
    if (!list || list._sortableInited) return;
            ...
            <select wire:change="selectUser($event.target.value)" class="pbo-user-select">
                @foreach($teleprospecteurs as $user)
                    <option value="{{ $user['id'] }}" {{ $selectedUserId === $user['id'] ? 'selected' : '' }}>
                        {{ $user['nom_complet'] }} — {{ $user['nb_actifs'] }} prospect{{ $user['nb_actifs'] > 1 ? 's' : '' }}
                    </option>
                @endforeach
        ...
        <div class="pbo-filters-row">
            ...
            <div class="pbo-filter-group" style="justify-content: flex-end;">
                ...
                <label style="flex-direction:row; align-items:center; gap:6px; height:34px; cursor:pointer; font-size:12.5px; font-weight:500; color:var(--pbo-text);">
                    <input wire:model.live="filterRappelOnly" type="checkbox" class="pbo-checkbox" style="flex-shrink:0;">
                    Rappels seulement
                </label>
            </div>
    ...
    <div class="pbo-table-wrap">
        ...
        <div class="pbo-table-header">
            <div class="pbo-th" style="justify-content:center;">
                <input type="checkbox" class="pbo-checkbox" onchange="pboSelectAll(this)" title="Tout sélectionner">
            </div>
                    ...
                    @foreach($list as $i => $p)
                        ...
                        <div
                            ...
                            <div class="pbo-cell pbo-col-check">
                                <input type="checkbox" class="pbo-checkbox row-check" value="{{ $p['id'] }}">
                            </div>
                                ...
                                <div class="pbo-nom-text">
                                    ...
                                    <div class="pbo-nom-sub">
                                        ...
                                        @else
                                            &nbsp;
                                        @endif
                                        @if($p['nb_salaries']) · {{ $p['nb_salaries'] }} sal. @endif
                                    </div>
                                </div>
                            </div>
