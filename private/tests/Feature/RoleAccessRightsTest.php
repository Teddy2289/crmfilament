...
class RoleAccessRightsTest extends TestCase
{
    ...
    public function catalog_groups_permissions_by_entity_or_module(): void
    {
        ...
        $this->assertArrayHasKey('AOPIA - Opportunités', $groups);
        ...
        $this->assertArrayHasKey('opportunites.view_any', $groups['AOPIA - Opportunités']);
        ...
        $this->assertSame('AOPIA - Opportunités - Lister', $flatOptions['opportunites.view_any']);
        ...
        $this->assertSame('AOPIA - Opportunités - Nom entité - Voir', $fieldOptions['fields.opportunites.nom_entite.show']);
